...
// 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
		...
		if (req.body.username == null || req.body.username == '' || req.body.password == null || req.body.password == '' || req.body.email == null || req.body.email == '' || req.body.name == null || req.body.name == '') {
			...
			user.save(function(err) {
				if (err) {
					...
					text: 'Hello<strong> ' + user.name + ', Thank you for registering at localhost.com. Please click on the link below to complete your activation: http://localhost:8080/activate/' + user.temporarytoken,
					...
					user.save(function(err) {
						if (err) {
							...
							var email = {
								...
								text: 'Hello<strong> ' + user.name + ', Your account has been successfully activated!',
			...
			user.save(function(err) {
				if (err) {
					...
					var email = {
						...
						text: 'Hello<strong> ' + user.name + ', You recently requested a new account activation link. Please click on the link below to complete your activation: http://localhost:8080/activate/' + user.temporarytoken,
